...
public class MainViewAdapter extends RecyclerView.Adapter<MainViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MainViewAdapter.ViewHolder holder, int position) {
        ...
        holder.txtCard.setText(tableInfo.get(position).gettCardName());
        holder.imgCard.setImageResource(context.getResources().getIdentifier(tableInfo.get(position).gettIdName(),
